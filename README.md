...
```shell
dockermgr download src homey
```

OR

```shell
git clone "https://github.com/casjaysdevdocker/homey" "$HOME/Projects/github/casjaysdevdocker/homey"
```

## Build container  

```shell
cd "$HOME/Projects/github/casjaysdevdocker/homey"
buildx 
```
